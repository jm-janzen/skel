...
if has("gui_running") || &t_Co == 256
    hi Normal cterm=NONE ctermfg=250 ctermbg=16 gui=NONE guifg=#bcbcbc guibg=NONE
    hi Keyword cterm=NONE ctermfg=255 ctermbg=16 gui=NONE guifg=#eeeeee guibg=NONE
    " TODO mk red
    ...
    hi SpellRare cterm=NONE ctermfg=124 ctermbg=16 gui=NONE guifg=#af0000 guibg=NONE
    ...
    hi SpecialKey cterm=NONE ctermfg=16 ctermbg=255 gui=NONE guifg=NONE guibg=#eeeeee
    hi MatchParen cterm=NONE ctermfg=16 ctermbg=240 gui=NONE guifg=NONE guibg=#585858
    hi CursorLine cterm=NONE ctermfg=NONE ctermbg=233 gui=NONE guifg=NONE guibg=#121212
    hi StatusLine cterm=bold,reverse ctermfg=245 ctermbg=16 gui=bold,reverse guifg=#8a8a8a guibg=NONE
    hi StatusLineNC cterm=reverse ctermfg=236 ctermbg=16 gui=reverse guifg=#303030 guibg=NONE
    hi Visual cterm=reverse ctermfg=250 ctermbg=16 gui=reverse guifg=#bcbcbc guibg=NONE
    ...
    hi DiffText cterm=NONE ctermfg=fg ctermbg=NONE guibg=NONE
    ...
    " Gee, I wonder
    hi MatchParen cterm=bold ctermfg=White ctermbg=NONE gui=bold guifg=White guibg=NONE
