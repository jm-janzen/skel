...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi DiffAdd term=NONE cterm=NONE ctermbg=none ctermfg=fg
    CSAHi DiffChange term=NONE cterm=NONE ctermbg=none ctermfg=fg
    CSAHi DiffDelete term=NONE cterm=NONE ctermbg=none ctermfg=fg
